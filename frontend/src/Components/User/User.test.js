...
describe("Testes do componente User", () => {
  test("testa renderização do componente", () => {
    ...
    expect(container.innerHTML).toMatchInlineSnapshot(
      `"<tr><td>eduardo</td><td>000.000.000-00</td><td>Pfizer</td><td>01/07/2021</td><td>Pfizer</td><td>02/10/2021</td><td>Pfizer</td><td>05/01/2022</td><td><div class=\\"actions\\"><a data-testid=\\"edit-link\\" class=\\"edit\\" href=\\"/edicao/1\\"><svg>edit.svg</svg></a><button data-testid=\\"delete-button\\" class=\\"delete\\"><svg>delete.svg</svg></button></div></td></tr>"`
    );
  });
